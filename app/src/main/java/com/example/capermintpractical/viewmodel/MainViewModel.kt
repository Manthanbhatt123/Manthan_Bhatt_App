package com.example.capermintpractical.viewmodel
...
class MainViewModel(application: Application) : AndroidViewModel(application), SensorEventListener {
    ...
    fun loadNightModeSettings() {
        ...
        _startTime.value = String.format(Locale.getDefault(), "%02d:%02d", prefs.startHour, prefs.startMinute)
        _endTime.value = String.format(Locale.getDefault(), "%02d:%02d", prefs.endHour, prefs.endMinute)
    ...
    fun updateTime(isStartTime: Boolean, hour: Int, minute: Int) {
        ...
        if (isStartTime) {
            ...
            _startTime.value = String.format(Locale.getDefault(), "%02d:%02d", hour, minute)
        } else {
            NightModeManager.saveSettings(getApplication(), prefs.enabled, prefs.startHour, prefs.startMinute, hour, minute)
            _endTime.value = String.format(Locale.getDefault(), "%02d:%02d", hour, minute)
        }
        applyNightMode()
    }
